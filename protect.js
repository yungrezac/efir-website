(() => {
  ...
  form.addEventListener('submit',async event=>{
    ...
    try{
      ...
      else {title.textContent=data.license==='unknown'?'Не удалось проверить лицензию. Попробуйте ещё раз.':'Стрим онлайн, использование ТАЙМЕРА не подтверждено';tone='unconfirmed';}
